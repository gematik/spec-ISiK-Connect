...
Für diesen Zweck wurden [FHIR-Profile](https://simplifier.net/guide/isik-basis-v3/ImplementationGuide-markdown-Einfuehrung?version=current) und ein REST-basiertes Application Programming Interface (API) entwickelt. Die REST-API wird im Wesentlichen [vom FHIR Standard vorgegeben](https://www.hl7.org/fhir/R4/http.html).
